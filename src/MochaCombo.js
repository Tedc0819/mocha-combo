...
class InputCombinationTestSuite {
  ...
  async runTest(test, combination) {
    ...
    await this.stub(test, combination)

    await this.setFixtures(test, combination)
    ...
    try {
      ...
      res = await this.testMethod(test, combination, argValues) || null
  ...
  combinations() {
    ...
    return cartesianProduct(extractedTypeArrays).concat(self.extraCombinations())
